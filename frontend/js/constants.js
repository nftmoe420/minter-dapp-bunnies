const contractAddress = "0xa4594c99C7ffc116a48B6D7fb9bea34bB2a3e3d7"; // Replace with your own contract address
const chain = 'rinkeby'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to the CodeCats NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The green people Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own stupid ass NFT Collection.';
